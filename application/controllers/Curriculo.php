...
class Curriculo extends CI_Controller {
	...
	public function index()
	{
		...
		$sessao_id = $this->session->userdata('id');

		if(isset($sessao_id))
		{	

				$this->load->model('Curriculo_model');
				$resultado = $this->Curriculo_model->carregar_curriculo($sessao_id);
				...
				$this->load->view('curriculo_view',$resultado);
		}
		else
		{
			redirect('/login');
	...
	public function update()
	{
		...
		$this->load->model('Curriculo_model');
		$resultado = $this->Curriculo_model->salvar_curriculo($sessao_id,$dados);
