<?php
	...
	//$export_url="/sistema/index.php/Admin/index/exportar/export";
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		...
		<div class="tDiv3">
			<?php if(!$unset_export) { ?>
        	<a class="export-anchor" data-url="<?php echo base_url('index.php/admin/exportar/export');  ?>" target="_blank">
				<div class="fbutton">
					<div>
